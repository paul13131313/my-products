...
| # | タイトル | URL | 概要 |
|---|---------|-----|------|
| 1 | AI構文つく〜る | https://ai-koubun.vercel.app/ | 日本語をAIっぽい言い回しに変換するWebアプリ |
| 2 | GHOST | https://ghost-copywriter-eta.vercel.app | AIが7つのスタイルでコピーを自動生成するツール |
| 3 | DARK SCANNER | https://paul13131313.github.io/dark-scanner/ | CIA/軍事偵察分析風ダークテックHUD画像ジェネレーター |
| 4 | VIDEO FACTORY | https://paul13131313.github.io/video-factory/ | AIチャット会話をMP4動画に変換。Claude・ChatGPT・LINE対応 |
| 5 | 人力飛行機つくーる | https://paul13131313.github.io/birdman/ | カイロソフト風・人力飛行機シミュレーションゲーム |
| 6 | {vibe_coding_club} | https://paul13131313.github.io/vcc/ | vibe codingクラブのランディングページ |
...
| 25 | yoin | https://paul13131313.github.io/loopmusic/ | 直感的に音を鳴らして遊べるアプリ |
| 26 | photomap | https://paul13131313.github.io/photomap/ | 写真を地図上にマッピング |
| 27 | MYPAY | https://paul13131313.github.io/mypay/ | 自分だけのペイが作れる |
| 28 | 投票シミュレーション | https://paul13131313.github.io/election/ | 衆議院選挙のWEB投票をバーチャル体験 |
...
| 54 | KAFUN PARAPARA | https://kafunparapara.vercel.app | リアルタイム花粉データ連動の花粉トラッカー。ギャル3Dキャラアニメーション×花粉レベル5段階×Canvas花粉パーティクル。気温・風速・季節ベース花粉推定ロジック・スプラッシュ画面・隠しデバッグコマンド付き |
...
- リポジトリ: sanpos
- URL: https://paul13131313.github.io/sanpos-lp/
- TestFlight: App ID 6760219795
- 状態: 🟡 TestFlight配信中
...
## 激写！熱愛メーカー
- リポジトリ: scoop
- URL: https://paul13131313.github.io/scoop/
- 状態: 🟢 公開中
- 技術: Vite + React + TypeScript + Tailwind CSS + Canvas API
...
- デプロイ: Vercel（GitHub push で自動デプロイ）
## 日本の出版マップ (JAPAN PUBLISHING MAP)
- リポジトリ: japan-publishing-map
- URL: https://japan-publishing-map.vercel.app/
- 状態: 🟢 Phase 1-2 完了・公開中
- 技術: Next.js + Supabase + Vercel Cron + NDL OpenSearch API + Recharts
